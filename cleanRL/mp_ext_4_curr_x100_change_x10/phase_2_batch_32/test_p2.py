...
class Agent(nn.Module):
    def __init__(self, policy_in_dim, policy_out_dim, encoder_in, encoder_out, device):
        super().__init__()
        ...
        self.actor_env_encoder = ProprioAdaptTConv(act_obs_sum_dim=encoder_in, out_dim=encoder_out)
        self.critic_env_encoder = ProprioAdaptTConv(act_obs_sum_dim=encoder_in, out_dim=encoder_out)
    ...
    def get_action(self, obs, 
        ...
        # env_factor = torch.rand(env_factor.shape).to("cuda:0")
